...
<head>
    ...
    <title>ЛИДЕР СОФТ-ВНЕДРЕНЧЕСКИЙ ЦЕНТР | Продажа и внедрение 1С</title>
    ...
    <style>
        :root {
            ...
            --dark-yellow: #E6B800;
            --accent-red: #AA0000; /* Изменено с синего на красный */
            --dark-red: #730000;   /* Изменено с синего на красный */
            --light-gray: #f5f5f5;
            --dark-gray: #333333;
            --text-color: #222222;
            --white: #ffffff;
